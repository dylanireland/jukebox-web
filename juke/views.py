...
def getFAQ():
    dict = {
        ...
        "Can I sell my time slot back to Jukebox?": "Currently, once you purchase the right to have your song played, it will play during the designated interval and cannot be changed or refunded. In v2, time slots will be able to be sold as NFTs. See <a href='future-work' class='colorfulLink'>Future Work</a>"
        }
    return dict.items()
